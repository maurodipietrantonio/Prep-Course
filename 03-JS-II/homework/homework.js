...
function fizzBuzz(numero) {
  ...
  if (Number.isInteger(numero/3) && Number.isInteger(numero/5)) {return "fizzbuzz"}
  else if (Number.isInteger(numero/5)) {return "buzz"}
  else if (Number.isInteger(numero/3)) {return "fizz"}
  else {return numero}
}
